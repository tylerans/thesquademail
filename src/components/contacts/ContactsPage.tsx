    ...
    <div className="flex-1 flex flex-col h-full bg-white overflow-hidden">
      ...
      <div className="px-8 py-6 border-b border-slate-100">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-slate-400 mt-0.5">{contacts.length} contacts</p>
          </div>
          <button
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 rounded-lg bg-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all border border-transparent focus:border-slate-200"
          />
        </div>
      </div>
      ...
      {addingNew && (
        <div className="px-8 py-4 bg-blue-50 border-b border-blue-100">
          <p className="text-sm font-semibold text-blue-900 mb-3">New Contact</p>
          ...
          <div className="flex gap-2 mt-3">
            ...
            <button
              ...
              className="px-4 py-1.5 rounded-lg border border-slate-200 text-sm font-medium text-slate-600 hover:bg-slate-50 transition-all"
            >
              Cancel
            </button>
          </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-100">
                <th className="text-left px-8 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">
                  Name
                </th>
                    ...
                    <td className="px-8 py-3">
                      {isEditing ? (
                        <input
                          ...
                          className="px-2 py-1 rounded border border-slate-200 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 w-full"
                        />
                      ) : (
                      ...
                      {isEditing ? (
                        <div className="flex items-center gap-1 justify-end">
                          <button
                            ...
                            disabled={saving}
                            className="p-1.5 rounded hover:bg-green-100 text-green-600 transition-all"
                          >
                            {saving ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <Check className="w-3.5 h-3.5" />}
                          </button>
                          <button
                            onClick={() => setEditingId(null)}
                            className="p-1.5 rounded hover:bg-slate-100 text-slate-500 transition-all"
                          >
                        ...
                        <div className="flex items-center gap-1 justify-end opacity-0 group-hover:opacity-100 transition-opacity">
                          <button
                            ...
                            className="px-2 py-1 rounded text-xs text-blue-600 hover:bg-blue-50 font-medium transition-all"
                          >
                            Email
                          </button>
                          <button
                          ...
                          <button
                            ...
                            className="p-1.5 rounded hover:bg-red-50 text-slate-400 hover:text-red-500 transition-all"
                          >
