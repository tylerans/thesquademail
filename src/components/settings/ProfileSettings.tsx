...
export default function ProfileSettings() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-base font-semibold text-slate-900 mb-1">Profile & Signature</h3>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between px-4 py-3 bg-slate-50">
                  <div>
                    <p className="text-sm font-semibold text-slate-900">{account.address}</p>
                  ...
                  <div className="px-4 py-4 space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={5}
                        placeholder={`--\nYour Name\nYour Title | Company\nphone@example.com`}
                        className="w-full px-3 py-2 rounded-lg border border-slate-200 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                      />
                      <p className="text-xs text-slate-400 mt-1">
